...
import excecao.HandlerGlobalException;
import excecao.ViolacaoDeConstraintException;
        ...
        while (continua) {
            ...
            switch (opcao) {
                case 1 -> {
                    ...
                    cep = Console.readLine("Informe o CEP: ");
                    interesses = Console.readLine("Informe os seus interesses: ");
                ...
                case 7 -> {
                    ...
                    qtdItens = Console.readLine("Informe a quantidade de itens: ");

                    pedido = new Pedido(nome, dataPedido, dataEntrega, qtdItens);
                    ...
                    try {
                        ...
                        System.out.println("\nPedido com id " + pedido.getId() + " cadastrado com sucesso!");
                ...
                case 8 -> {
                    ...
                    try {
                        ...
                        System.out.println("\nPedido de ID " + pedido.getId() + " alterado com sucesso!");
                        System.out.println(pedido);
                    } catch (ViolacaoDeConstraintException | EntidadeNaoEncontradaException e) {
                        System.out.println(e.getMessage());
                    }
                ...
                case 9 -> {
                    ...
                    if (resp.equals("s")) {
                        try {
                            restTemplate.delete("http://localhost:8080/pedidos/{id}", pedido.getId());

                            System.out.println("\nPedido de ID " + pedido.getId() + " removido com sucesso!");
                        } catch (EntidadeNaoEncontradaException e) {
                            System.out.println(e.getMessage());
                        }
                    } else {
